...
Patience is a native macOS application built with Swift and SwiftUI for comprehensive chatbot testing and validation.
...
- Native macOS GUI built with SwiftUI
- Real-time chatbot testing and monitoring
- AI-powered adversarial testing with multiple providers
...
This workspace is Kiro-enabled with Model Context Protocol (MCP) integration for enhanced AI-assisted development.
